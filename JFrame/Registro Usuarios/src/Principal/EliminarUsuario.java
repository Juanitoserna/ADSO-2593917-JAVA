        ...
        for (int i=0; i<this.ventanaMenu.listaPersonas.length; i++) {
            if(this.ventanaMenu.listaPersonas[i] != null){
                if (this.ventanaMenu.listaPersonas[i].getCedula().equals(cedula)) {
                    tfMostrar.setText(i+" => "+this.ventanaMenu.listaPersonas[i].getCedula()+" - "+this.ventanaMenu.listaPersonas[i].getNombres()+" "+this.ventanaMenu.listaPersonas[i].getApellidos()+" "+this.ventanaMenu.listaPersonas[i].getTelefono()+" "+this.ventanaMenu.listaPersonas[i].getDireccion());
                    
                }else if(this.ventanaMenu.listaPersonas[i].getCedula() == null){
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        for (int i=0; i<this.ventanaMenu.listaPersonas.length; i++){
            if(this.ventanaMenu.listaPersonas[i] != null){
                if(this.ventanaMenu.listaPersonas[i].getCedula().equals(cedula)){
                    this.pos = i;
                    this.ventanaMenu.listaPersonas[i].setCedula("");
                    this.ventanaMenu.listaPersonas[i].setNombres("");
                    this.ventanaMenu.listaPersonas[i].setApellidos("");
                    this.ventanaMenu.listaPersonas[i].setTelefono("");
                    this.ventanaMenu.listaPersonas[i].setDireccion("");
                    this.ventanaMenu.listaPersonas[i].setEmail("");
                    for (int j=pos; j<this.ventanaMenu.listaPersonas.length-1; j++){
                        Persona temporal1 = new Persona(cedula, cedula, cedula, cedula, cedula, cedula);
                        temporal1 = this.ventanaMenu.listaPersonas[j];
                        this.ventanaMenu.listaPersonas[j] = this.ventanaMenu.listaPersonas[j+1];
                        this.ventanaMenu.listaPersonas[j+1] = temporal1;
        ...
        this.ventanaMenu.listaPersonas[99] = null; 
        this.ventanaMenu.setVisible(true);
        dispose();
