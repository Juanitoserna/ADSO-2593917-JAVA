...
public class ModificarVendedor extends javax.swing.JFrame {
        ...
        for (int i=0; i<this.ventanaMenu.lista_vendedor.length; i++) {
            if(this.ventanaMenu.lista_vendedor[i] != null){
                if (this.ventanaMenu.lista_vendedor[i].getCedula().equals(cedula)) {
                    ...
                    campoNombres.setText(this.ventanaMenu.lista_vendedor[i].getNombres());
                    campoApellidos.setText(this.ventanaMenu.lista_vendedor[i].getApellidos());
                    campoTelefono.setText(this.ventanaMenu.lista_vendedor[i].getTelefono());
                    campoDireccion.setText(this.ventanaMenu.lista_vendedor[i].getDireccion());
                    campoEmail.setText(this.ventanaMenu.lista_vendedor[i].getEmail());
                    this.pos = i;
                }else{
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        this.ventanaMenu.lista_vendedor[pos].setNombres(campoNombres.getText());
        this.ventanaMenu.lista_vendedor[pos].setApellidos(campoApellidos.getText());
        this.ventanaMenu.lista_vendedor[pos].setTelefono(campoTelefono.getText());
        this.ventanaMenu.lista_vendedor[pos].setDireccion(campoDireccion.getText());
        this.ventanaMenu.lista_vendedor[pos].setEmail(campoEmail.getText());
        this.ventanaMenu.setVisible(true);
        dispose();
