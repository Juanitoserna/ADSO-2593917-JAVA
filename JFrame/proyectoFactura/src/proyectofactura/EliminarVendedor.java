        ...
        for (int i=0; i<this.ventanaMenu.lista_vendedor.length; i++) {
            if(this.ventanaMenu.lista_vendedor[i] != null){
                if (this.ventanaMenu.lista_vendedor[i].getCedula().equals(cedula)) {
                    tfMostrar.setText(i+" => "+this.ventanaMenu.lista_vendedor[i].getCedula()+" - "+this.ventanaMenu.lista_vendedor[i].getNombres()+" "+this.ventanaMenu.lista_vendedor[i].getApellidos()+" "+this.ventanaMenu.lista_vendedor[i].getTelefono()+" "+this.ventanaMenu.lista_vendedor[i].getDireccion());
