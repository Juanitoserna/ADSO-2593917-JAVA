...
<body>
    <div class="container" id="principal" style="margin-top: 5%">
        <div class="mt-5 p-3" style="border: 1px solid rgb(48, 159, 233); box-shadow: 0px 0px 15px 0px rgb(48, 159, 233);">
            <h1 class="mt-2 mb-2 text-center">Regristro De Reuniones</h1>
                ...
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-11">
                            ...
                            <textarea class="form-control" name="descripcion" id="inputDescripcion" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-11">
                            ...
                            <input type="date" class="form-control" id="fechas" name="fecha">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
